...
if __name__ == '__main__':
    ...
    train_data_dict = pickle.load(open('pre_proc_train_data.pickle', 'rb'))
    train_ds = VizWizDataset(train_data_dict)
    val_data_dict = pickle.load(open('pre_proc_val_data.pickle', 'rb'))
    ...
    train_dataloader = DataLoader(train_ds, args.batch_size,
                                  shuffle=True, num_workers=1)
    val_dataloader =  DataLoader(val_ds, args.batch_size,
                                 shuffle=True, num_workers=1)
    train_model(train_dataloader, val_dataloader,
                model, args.n_epochs, args.save_loc)
